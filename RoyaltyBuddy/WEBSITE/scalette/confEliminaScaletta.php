<?php
	...
	$traduttore = new NtxTraduttore("SCA_000_002", "IT", $_SESSION[NTX_LINGUA_DEST]);
	//$traduttore = new NtxCreaTraduzione("SCA_000_002", "IT", __FILE__);
	
	$idScaletta = $_SESSION['idSelect'];
	
	$datiScaletta = "	SELECT     	scalette.nomeScaletta
						FROM       	scalette
						WHERE		idScaletta = $idScaletta
						AND 		validate = 1";
	
	$query = ntxQuery($datiScaletta);
		...
		<div data-role="page" data-theme="b">
			<div role="main" class="ui-content" >
				<div style="" class="confEli ui-nodisc-icon alertCancella"><!-- Class added to the wrapper -->
					<p><?php $traduttore->html('Confermare l\'eliminazione della scaletta') ?><br> <b class="boldElimina"><?php echo $html['nomeScaletta'] ?> </b>?
					</p>
					<a onclick="eliminaScaletta()" class="check ui-btn ui-shadow ui-corner-all ui-icon-check ui-btn-icon-notext ui-btn-b ui-btn-inline">Check</a>
