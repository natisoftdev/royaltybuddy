<?php
	...
	$traduttore = new NtxTraduttore("ACC_000_003", "IT", $_SESSION[NTX_LINGUA_DEST]);
	//$traduttore = new NtxCreaTraduzione("ACC_000_003", "IT", __FILE__);
		...
		<div data-role="page" data-theme="b">
			<div role="main" class="ui-content" >
				<div style="" class="confEli ui-nodisc-icon alertCancella"><!-- Class added to the wrapper -->
					<p>
						<?php $traduttore->html('Confermare l\'eliminazione dell\'utente') ?>
						<br>
						<b class="boldElimina">
							<?php echo $html['nome'].' '.$html['cognome'] ?>
						</b>?
					</p>
					<!-- Scelta -->
					<a onclick="eliminaAccount()" class="check ui-btn ui-shadow ui-corner-all ui-icon-check ui-btn-icon-notext ui-btn-b ui-btn-inline">Check</a>
